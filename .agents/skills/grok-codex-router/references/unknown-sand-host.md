...
5. Reproduce against a local host fixture or disposable copy. Run bun run check, grok-codex-router patch-host --check, direct verification, and a native Grok Bot turn before considering recovery complete.
