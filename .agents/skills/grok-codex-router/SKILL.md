...
4. Use Switch off and Switch on, or grok-codex-router off and grok-codex-router on, to change inference source. Keep the patch and control service installed so routes and recovery remain available.
