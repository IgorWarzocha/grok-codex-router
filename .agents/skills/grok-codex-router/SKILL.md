...
3. Run grok-codex-router status before acting. Use the control UI at http://127.0.0.1:3210 for ordinary routing, usage, logs, and recovery.
...
6. After transport, patch, or recovery changes, run npm run check, grok-codex-router patch-host --check, grok-codex-router verify, and one native Grok Bot tool and delivery turn.
